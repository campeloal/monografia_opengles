...
@TargetApi(Build.VERSION_CODES.FROYO) public class GouraudShader extends Shader{
	...
	int normalMatrixAddr,lightPosAddr,lightColorAddr,matAmbientAddr,matDiffuseAddr,
	matSpecularAddr,matShininessAddr, eyePosAddr, aNormalAddr;
